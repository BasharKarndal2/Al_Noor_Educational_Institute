  <div class="modal fade" id="viewAssessmentteacherModal" tabindex="-1" aria-labelledby="viewAssessmentModalLabel" aria-hidden="true">
...
$(document).on('click', '.viewAssessmentBtn', function () {
    ...
    $.ajax({
        url: '/evaluationsteacher/showdata/' + evaluationId,
        type: 'GET',
